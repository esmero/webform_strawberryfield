...
class strawberryFieldharvester extends WebformHandlerBase
{
  ...
  public function preSave(WebformSubmissionInterface $webform_submission)
  {
    ...
    if (isset($values["strawberry_field_widget_state_id"])) {
      ...
      try {
        ...
        $this->loggerFactory->get('archipelago')->error('Webform @webformid can not write to temp storage! with error @message. Attempted Metadata input was <pre><code>%data</code></pre>', [
      ...
      $this->loggerFactory->get('archipelago')->error('Webform @webformid lost connection to temp storage and its Widget!. No Widget State id present. Attempted Metadata input was <pre><code>%data</code></pre>', [
        '@webformid' => $this->getWebform()->id(),
        '%data' => print_r($webform_submission->getData(), TRUE),
      ]);
    }
  ...
  public function validateForm(array &$form, FormStateInterface $form_state, WebformSubmissionInterface $webform_submission)
  {
    ...
    if ((!isset($values["strawberry_field_widget_state_id"]) || empty($values["strawberry_field_widget_state_id"])) && $this->IsWidgetDriven()) {
      ...
      $this->loggerFactory->get('archipelago')->error('Webform @webformid lost connection to temp storage!. No Widget State id present. Attempted Metadata input was <pre><code>%data</code></pre>', [
        '@webformid' => $this->getWebform()->id(),
        '%data' => print_r($webform_submission->getData(), TRUE),
      ]);
    }
