 ...
 *
 * @FormElement("webform_metadata_viaf")
 */
class WebformViaf extends WebformCompositeBase {
  ...
  public function getInfo() {
    //@TODO expose options inside \Drupal\webform_strawberryfield\Plugin\WebformElement\WebformViaf
    $info = parent::getInfo();
    return $info;
  }
  ...
  public static function getCompositeElements(array $element) {
    $elements = [];
    $class = '\Drupal\webform_strawberryfield\Element\WebformViaf';
    $elements['label'] = [
      '#type' => 'textfield',
      '#title' => t('Label'),
      '#autocomplete_route_name' => 'webform_strawberryfield.auth_autocomplete',
      '#autocomplete_route_parameters' => array('auth_type' => 'viaf', 'count' => 10),
      '#attributes' => [
  ...
  public static function processWebformComposite(&$element, FormStateInterface $form_state, &$complete_form) {
    ...
    // To get around that we call \Drupal\webform_strawberryfield\Plugin\WebformElement\WebformViaf::hiddenElementAfterBuild
  ...
  public static function processAutocomplete(&$element, FormStateInterface $form_state, &$complete_form) {
    ...
    $element['#attributes']['data-strawberry-autocomplete'] = 'viaf';
    return $element;
  }
