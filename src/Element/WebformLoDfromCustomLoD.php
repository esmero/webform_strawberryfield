...
/**
 * Provides a webform element for a LoD from Custom LoD Endpoint.
 *
 * @FormElement("webform_metadata_customlod")
 */
class WebformLoDfromCustomLoD extends WebformCompositeBase {
  ...
  public static function getCompositeElements(array $element) {
    ...
    $class = '\Drupal\webform_strawberryfield\Element\WebformLoDfromCustomLoD';
    $elements['label'] = [
      '#type' => 'search',
      '#title' => t('Label'),
      '#attributes' => [
  ...
  public static function processAutocomplete(&$element, FormStateInterface $form_state, &$complete_form) {
    ...
    $element['#attributes']['data-strawberry-autocomplete'] = 'webform_metadata_customlod';
    return $element;
  }
