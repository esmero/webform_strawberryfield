  ...
  Drupal.behaviors.date = {
    attach: function (context, settings) {
      ...
      $context.find('input[data-drupal-date-format]').once('datePicker').each(function () {
        ...
        // If dateformat is actually just a four digit year, then make navigation just on years.
        if (options.dateFormat == 'yy') {

            options.changeMonth = false;
            options.buttonText = Drupal.t('Select Year');
        } else {
            // Max/min dates don't work with pure year selection
