 ...
 */
abstract class MetadataDateBase extends WebformElementBase {
  ...
  public function prepare(array &$element, WebformSubmissionInterface $webform_submission = NULL) {
    ...
    if (isset($element['#date_date_format'])) {
      ...
      if ($date_min) {
        $element['#attributes']['min'] = static::formatDate('Y-m-d', strtotime($date_min));
      ...
      if (!empty($date_max)) {
        $element['#attributes']['max'] = static::formatDate('Y-m-d', strtotime($date_max));
    ...
    $element['#attached']['library'][] = 'webform_strawberryfield/webform_strawberryfield.element.metadatadate';
